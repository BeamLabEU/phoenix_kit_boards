...
This directory contains documentation for significant pull requests merged into PhoenixKit Boards. It serves as an archive of design decisions, review feedback, and implementation context that lives within the repository.
...
├── 2026/                     # Year
│   ├── 1-add-collaborative-boards-module/
